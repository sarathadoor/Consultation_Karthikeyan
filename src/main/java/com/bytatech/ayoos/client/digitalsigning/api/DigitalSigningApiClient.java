...
@FeignClient(name="${alfrescoRestApi.name:alfrescoRestApi}", url="${alfrescoRestApi.url:http://35.238.35.19:8013/alfresco/service}", configuration = ClientConfiguration.class)

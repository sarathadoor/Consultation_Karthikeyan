...
@FeignClient(name="${alfrescojhipster.name:alfrescojhipster}", url="${alfrescojhipster.url:http://35.238.35.19:8013/alfresco/service}", configuration = ClientConfiguration.class)
